...
public class registerPage extends Frame {
    ...
    void VotingAppRegister() {
     ...
     // Center the frame on the screen
        ...
        // Heading Label
        Label headingLabel = new Label("Voter Registration", Label.CENTER);
    ...
    // Helper method to show dialog with Candidate ID
    private void showIDDialog(String candidateID) {
        Dialog dialog = new Dialog(this, "Candidate ID", true);
